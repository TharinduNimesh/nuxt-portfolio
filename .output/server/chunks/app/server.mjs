import { hasInjectionContext, getCurrentInstance, version, ref, watchEffect, watch, defineAsyncComponent, toRef, isRef, defineComponent, h, inject, computed, unref, provide, shallowReactive, Suspense, nextTick, Transition, mergeProps, useSSRContext, createApp, effectScope, reactive, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, isShallow, isReactive, toRaw, withCtx } from 'vue';
import { d as useRuntimeConfig$1, $ as $fetch, w as withQuery, l as hasProtocol, p as parseURL, m as isScriptProtocol, j as joinURL, h as createError$1, n as klona, o as defu, q as sanitizeStatusCode, r as defuFn, t as createHooks } from '../../index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-0c9acfb8.mjs').then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./_nuxt/Icon-6a65ae77.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-11b06185.mjs').then((r) => r.default));
...
const _neutral = "var(--fallback-n,oklch(var(--n)/<alpha-value>))";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-dccd42e5.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-7e054862.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-842404a8.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { _export_sfc as _, useState as a, useNuxtApp as b, createError as c, useRuntimeConfig as d, entry$1 as default, useRouter as e, navigateTo as f, useAppConfig as g, nuxtLinkDefaults as n, useHead as u };
